...
| P10 | A generated AWS-shaped access-key identifier (`AKIA` plus 16 uppercase alphanumeric characters) in an untracked Markdown file; run `gitleaks detect --no-git --source .` | gitleaks                                                             |                                          |                                                                               |
