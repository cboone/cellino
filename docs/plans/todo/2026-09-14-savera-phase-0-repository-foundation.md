...
| P10 | A generated AWS-shaped access-key identifier (`AKIA` plus 16 characters drawn from `[A-Z2-7]`) in an untracked Markdown file; run `gitleaks detect --no-git --source .` | gitleaks                                                             |                                          |                                                                               |
| P11 | The same string in an untracked `fixtures/plant.wav`                                                                                                                    | Nothing; the fixture allowlist entry, expected silent                |                                          |                                                                               |
